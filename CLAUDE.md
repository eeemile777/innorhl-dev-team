...
3. Read `CODEBASE_INDEX.md` if it exists (skip re-scanning files you already know)
...
- `CODEBASE_INDEX.md` is your map — load it, trust it, don't re-scan what it already covers
